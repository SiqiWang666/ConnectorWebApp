...
/** Get current user's profile. Send request to backend.
 */
...
/** Delete experience
 * @param id - the id of the experience that will be deleted
 */
...
/** Delete education
 * @param id - the id of the education that will be deleted
 */
